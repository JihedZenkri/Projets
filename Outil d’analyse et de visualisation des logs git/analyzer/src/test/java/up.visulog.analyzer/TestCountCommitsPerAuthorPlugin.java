...
public class TestCountCommitsPerAuthorPlugin {
    /*
     * Let's check whether the number of authors is preserved and that the sum of
     * the commits of each author is equal to the total number of commits
     */
    @Test
    public void checkCommitSum() {
	var log = new ArrayList<Commit>();
	String[] authors = { "foo <foo@gmail.com>", "bar <bar@gmail.com>", "baz <baz@gmail.com>" };
	var entries = 20;
